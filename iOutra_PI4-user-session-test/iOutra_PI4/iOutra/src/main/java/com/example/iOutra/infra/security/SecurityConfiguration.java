    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(registry -> {
                    ...
                    registry.requestMatchers("/backoffice/", "/backoffice/pedidos","/backoffice/produto/**","/backoffice/usuario/**", "/backoffice/pedidos/**").permitAll();
                    /* Estoquista ---> NÃO PODE ACESSAR /backoffice/listar-produtos */
                    registry.requestMatchers("/backoffice/usuarios").permitAll();
